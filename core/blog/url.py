...
from .views import  Indexview , RedirectToMaktab , PostlistView , PostDetailView , PostCreateView , PostEditView , PostDeleteView , api_post_list_view
...
urlpatterns = [
    ...
    path("post/" , api_post_list_view , name="api-post-list") 
]