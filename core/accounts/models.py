...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_staff = models.BooleanField(
        default=False
    )  # A boolean field that indicates whether the user can enter the admin site or not.
    is_active = models.BooleanField(
        default=True
    )  # A Boolean field indicating whether the user account is active or inactive.
    is_verified = models.BooleanField(
        default=False
    )  # A Boolean field indicating whether the user account is verified
